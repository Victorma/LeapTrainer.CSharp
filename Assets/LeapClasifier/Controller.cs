...
public class LeapTrainer : MonoBehaviour {
	...
	public StartedRecordingDelegate 	OnStartedRecording;
	public EndedRecordingDelegate 		OnEndedRecording;
	public GestureDetectedDelegate 		OnGestureDetected;
	public GestureCreatedDelegate 		OnGestureCreated;
	public GestureRecognizedDelegate 	OnGestureRecognized;
	public GestureUnknownDelegate 		OnGestureUnknown;
	public TrainingCountdownDelegate 	OnTrainingCountdown;
	public TrainingStartedDelegate 		OnTrainingStarted;
	public TrainingCompleteDelegate 	OnTrainingComplete;
	public TrainingGestureSavedDelegate OnTrainingGestureSaved;
	 ...
	 * @param options
	 */
	void Start(Controller controller, Dictionary<string, object> options) {
	...
	private class TrainerListener : Listener {
		...
		public TrainerListener(LeapTrainer lt){this.lt = lt;}
	...
	private void bindFrameListener() {
		...
		/**
	 	 ...
	 	 */
		this.controller.AddListener (new TrainerListener (this));
	...
	private float distributeAux(float f){
		return Mathf.Round((Random.Range(0,1)*2f - 1f) + 
		                   (Random.Range(0,1)*2f - 1f) + 
		                   (Random.Range(0,1)*2f - 1f) * 
	 ...
	 */
	void destroy() { 
		this.controller.RemoveListener(null);
	}
}
